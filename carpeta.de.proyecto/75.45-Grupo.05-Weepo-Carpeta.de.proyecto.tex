...
\begin{titlepage}
	...
	\begin{center}
		...
		\Large Ezequiel Reyes, Padrón Nro. 92.119 \\
		\large \textit{ezequielmreyes@gmail.com} \\ \medskip
...
\section{Frontend}
	...
	\itemsep=7pt \topsep=0pt \partopsep=0pt \parskip=0pt \parsep=0pt
		...
		\item \textit{Bootstrap}\footnote{\url{http://getbootstrap.com/}}: Este framework desarrollado por la gente de Twitter, simplifica el desarrollo de interfaces de usuario web elegantes. 
		
		\item \textit{AngularJS}\footnote{\url{https://angularjs.org/}}: Con este framework evitamos refrescar la página, realizando solicitudes en forma asíncrona y solo modificando sobre el navegador porciones del sitio a los que afectan los cambios producidos por dichas solicitudes .
		
		\item Es muy común utilizar varias librerías en los proyectos, tanto para sumar funcionalidades como así también para realizar tareas de testeo, compilación, minificación, entre otras. Para acelerar los procesos es que hemos integrado las herramientas \textit{YEOMAN}\footnote{\url{http://yeoman.io/}}, \textit{Grunt}\footnote{\url{http://bower.io/}} y \textit{Bower}\footnote{\url{http://gruntjs.com/}}, con el fin de poder iniciar un proyecto con una estructura predeterminada ya armada, administrar las dependencias de manera fácil y realizar procesos de compilación, pruebas y minificación rápidamente. 
...
Resumiendo lo explicado en secciones anteriores, nuestra plataforma está compuesta por un cliente que se conecta al servidor Node JS, el cual consulta datos de su base de datos (NoSQL), y para provisionar estas bases de datos con información de redes sociales se utilizan las APIs propias de estas. De esta manera, logramos la interacción entre los usuarios, el servidor y las redes sociales, generando estadísticas en forma muy ágil, rápida e integral entre varios servicios.


% Imagen 
\begin{figure}[H]
	\centering
	\includegraphics[width=0.9\textwidth]{images/esquema.png}
	\medskip
	\caption{Diagrama representativo de la estructura de componentes que conforma el sistema de Weepo.}
	\medskip
\end{figure}
...
En esta secci\'{o}n se muestran algunos de los casos de uso posibles para la plataforma Weepo.\\
